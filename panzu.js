    ...
    switch (commandName) {
      ...
      case 'pocket':
        ...
        if (canClaimDaily(userId)) {
          ...
          const lastDaily = pandaCoinData[userId].lastDaily;
          const nextClaim = lastDaily + (5 * 60 * 60 * 1000);
          const timeLeft = nextClaim - Date.now();
          const hoursLeft = Math.floor(timeLeft / (60 * 60 * 1000));
          const minutesLeft = Math.floor((timeLeft % (60 * 60 * 1000)) / (60 * 1000));

          await interaction.reply(`🐼 You've already claimed your reward!\n⏰ Come back in ${hoursLeft}h ${minutesLeft}m for your next reward.`);
        }
        break;
      ...
      case 'equip':
        ...
        // Check if user has the item
          ...
          if (equipGear(user.id, gearCategory, itemName)) {
            ...
            await interaction.reply(`✅ ${categoryEmojis[gearCategory]} You equipped your **${itemName}**! Use \`/inventory\` to see your equipped gear.`);
          } else {
